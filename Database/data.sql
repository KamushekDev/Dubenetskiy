...
SELECT pg_catalog.setval('public.process_history_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.process_permissions_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.process_step_resolutions_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.resolution_permissions_id_seq', 7, true);
